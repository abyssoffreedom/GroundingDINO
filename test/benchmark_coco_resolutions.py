...
def main():
    ...
    parser.add_argument("--anno_path", type=str, default=r"C:\Users\EmVis\coco\annotations_trainval2017\annotations\instances_val2017.json", help="coco annotation json")
    parser.add_argument("--image_dir", type=str, default=r"C:\Users\EmVis\coco\val2017\val2017", help="coco image dir")
